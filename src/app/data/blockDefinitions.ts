...
export function getShortDescription(blockTypeId: string): string {
  const shortDescriptions: Record<string, string> = {
    ...
    employment_verification: 'Employment & professional',
  };
    ...
    generalConfig: [
      {
        ...
        type: 'text',
        value: '',
        hint: 'Appears on the Razorpay checkout screen, customer\'s bank statement, UPI history, and payment receipt. Use a clear label like "Processing Fee — Personal Loan" for easy reconciliation.',
      },
      {
        id: 'amount_source',
        name: 'Amount Source',
      ...
      },
      {
        ...
        hint: 'If nothing is selected, your Razorpay portal settings will apply.',
      },
      {
        ...
        type: 'toggle',
        value: true,
        hint: 'Pre-fills name, email, and mobile from journey data into Razorpay checkout. Missing fields stay blank for the customer to fill.',
      },
      {

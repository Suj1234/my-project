...
export function JourneyCanvasA(props: JourneyCanvasAProps) {
  return (
    <ReactFlowProvider>
      <CanvasAInner {...props} />
    </ReactFlowProvider>
